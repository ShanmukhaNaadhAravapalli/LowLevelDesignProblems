...
class Participant implements Observer {
    ...
    @Override
    public void update(String message) {
        System.out.printf("Email sent to %s: %s%n", this.email, message);
       //System.out.println(String.format("Email sent to %s: %s", this.email, message));
    }
}
...
class MeetingScheduler {
    ...
    public MeetingRoom scheduleMeeting(String meetingId, String title, List<Participant> participants, TimeSlot timeSlot) {
        ...
        if (selectedRoom != null) {
            ...
            String notifyMsg = "Meeting scheduled in room " + selectedRoom.roomId +
                    " from " + timeSlot.startTime + " - " + timeSlot.endTime;
            selectedRoom.meeting.notifyParticipants(notifyMsg);
